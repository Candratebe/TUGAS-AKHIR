...
<html>
    ...
    <body>
        <div class="header">
            <h1>-RGaming Keyboard-</h1>
        </div>
        <div class="nav">
                <a href="http://localhost/uas/index.html">Home</a>
                <a href="http://localhost/uas/aboutme.html">About</a>
                <a href="http://localhost/uas/order.html">Order Produk</a> 
                <a href="http://localhost/uas/buku_tamu.php">Buku Tamu</a>
                <br>
        </div>
        <br><br>
        <div id="container">
